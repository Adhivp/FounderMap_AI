...
st.set_page_config(page_title="Marketing Strategy", page_icon="📈")

st.title("📈 Marketing Strategy Mind Map")

st.write("""
This mind map helps you outline your marketing strategy by considering key components such as:
- Market Segmentation
- Target Market
