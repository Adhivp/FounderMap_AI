...
st.set_page_config(page_title="Fundraising Strategy", page_icon="💸")

st.title("💸 Fundraising Strategy Mind Map")

st.write("""
This mind map helps you develop a comprehensive fundraising strategy by considering key elements such as:
- Funding Sources
- Investor Pitch
