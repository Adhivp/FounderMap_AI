...
st.set_page_config(page_title="Product Roadmap", page_icon="🛠")

st.title("🛠 Product Roadmap Mind Map")

st.write("""
This mind map helps you plan your product roadmap by considering key aspects such as:
- Product Vision
- Key Features
